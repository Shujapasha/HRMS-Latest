    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::text('appraisal_date', '', ['class' => 'form-control custom-datepicker', 'id' => 'data_picker1'  ,'required' => 'required']) }}
            </div>
        </div>
        <div class="form-group">
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('appraisal_date', __('Select Month'), ['class' => 'col-form-label']) }}
                {{ Form::text('appraisal_date', '', ['class' => 'form-control d_filter','autocomplete'=>'off' ,'placeholder'=>'Select month' ,'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
