                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::number('phone',!empty($jobOnBoard->applications)?$jobOnBoard->applications->phone:'', ['class' => 'form-control' ,'placeholder' => 'Enter Phone']) !!}
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::email('email',old('email'), ['class' => 'form-control','required' => 'required' ,'placeholder' => 'Enter email']) !!}
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                <div class="float-left col-4">
                                    <label for="document" class="float-left pt-1 col-form-label">{{ $document->name }} @if($document->is_required == 1) <span class="text-danger">*</span> @endif</label>
                                </div>
