        ...
        <div class="form-group col-md-6 profile d-none">
            ...
            <div class="choose-files ">
                <label for="image" >
                    ...
                    <img id="blah" src="{{asset('/storage/uploads/avatar/avatar.png')}}" width="100" />
                </label>
            </div>
        </div>
        <div class="form-group col-md-6 profile d-none">
            ...
            <div class="choose-files ">
                <label for="resume" >
                    ...
                    <img id="blah1" alt="your image" width="100"src="{{asset('/storage/uploads/job/resume/sample_resume_1653981149.png')}}"/>
                </label>
            </div>
        </div>
